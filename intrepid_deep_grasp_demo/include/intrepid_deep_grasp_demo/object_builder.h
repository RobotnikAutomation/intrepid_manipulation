#ifndef _INTREPID_DEEP_GRASP_DEMO__OBJECT_BUILDER_H_
#define _INTREPID_DEEP_GRASP_DEMO__OBJECT_BUILDER_H_
...
#endif // _INTREPID_DEEP_GRASP_DEMO__OBJECT_BUILDER_H_